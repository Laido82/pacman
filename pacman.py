...
code to run a game.c  This file is divided into three sections:
...
class PacmanRules:
    ...
    def applyAction(state, action):
        ...
        pacmanState.configuration = pacmanState.configuration.generateChild(
            vector)
...
class GhostRules:
    ...
    def applyAction(state, action, ghostIndex):
        ...
        ghostState.configuration = ghostState.configuration.generateChild(
            vector)
    applyAction = staticmethod(applyAction)
